...
export default function EuropeUniversityPage() {
  ...
  const programs = [
    ...
    },
    {
      ...
      description:
        "Access cutting-edge labs and innovation hubs",
      icon: <GraduationCap className="h-6 w-6 text-[#e11d48]" />,
    },
    {
      title: "Medicine & Life Sciences",
      description:
        "Train in world-renowned hospitals and research centers.",
      icon: <GraduationCap className="h-6 w-6 text-[#e11d48]" />,
    },
    {
      title: "Arts & Humanities",
      description:
        "Explore centuries of culture, philosophy, and creativity.",
      icon: <GraduationCap className="h-6 w-6 text-[#e11d48]" />,
    },
    {
      title: "Law & International Relations",
      description:
        "Learn from global leaders in policy and justice.",
  ...
  return (
    <UniversityPageTemplate
      ...
      testimonial={{
        quote:
          "Studying in Germany not only gave me a world-class education but also the chance to intern with global companies. It changed my career path forever",
        name: "Ananya M",
        title: "MSc Mechanical Engineering, TU Munich",
