...
export const metadata: Metadata = {
  title:
    "Study Abroad & Immigration Services for Indian Students | Transpacific",
  description:
    "Trusted by thousands, Transpacific helps Indian students study in countries like Canada, UK, USA, Australia, and New Zealand with expert visa and admission support.",
  alternates: {
  ...
  openGraph: {
    title:
      "Study Abroad & Immigration Services for Indian Students | Transpacific",
    description:
      "Get expert help to study in New Zealand,  Australia  Canada, USA, UK &Ireland. Trusted by thousands of Indian students since 2010.",
