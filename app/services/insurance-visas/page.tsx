...
const steps = [
  {
    ...
    description:
      "We help you choose and enroll in the right health insurance plans required by foreign universities or governments for international students.",
    image: "/services/insurance/1.png",
  },
  {
    title: "Family & Visitor Health Insurance",
    description:
      "Traveling with family or having relatives visit? We provide plans that cover medical emergencies, hospitalization, and routine checkups.",
    image: "/services/insurance/2.png",
  },
  {
    title: "Comprehensive Travel Insurance",
    description:
      "Protect your trip from disruptions, delays, lost luggage, and medical emergencies with travel insurance tailored to your needs.",
    image: "/services/insurance/3.png",
  },
  {
    title: "Claims Assistance",
    description:
      "Our team guides you in filing and tracking insurance claims to ensure timely reimbursement or support during your stay abroad.",
    image: "/services/insurance/4.png",
  },
];
    ...
    <div className="font-sans">
      ...
      <section className="min-h-screen bg-gradient-to-r from-[#3c3c3c] to-[#445366] text-white flex flex-col lg:flex-row items-center px-6 lg:px-20 py-20 gap-10">
        ...
        <div className="lg:w-2/3">
          <Image
            src="/services/services-hero/6.png"
            alt="Admission"
            width={500}
            height={600}
