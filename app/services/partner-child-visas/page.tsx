...
const steps = [
  {
    ...
    description:
      "We assist in securing visas for your spouse or partner, ensuring all relationship proofs and documentation meet the legal criteria of the destination country.",
    image: "/services/spouse-child/1.png",
  },
  {
    title: "Child/Dependent Visa",
    description:
      "We handle visa applications for your children or dependents, making sure their educational and caregiving needs are addressed in the visa process.",
    image: "/services/spouse-child/2.png",
  },
  {
    title: "Parent Visas",
    description:
      "If you're eligible to sponsor your parents, we guide you through the documentation and timelines involved in bringing them to live with or visit you.",
    image: "/services/spouse-child/3.png",
  },
  {
    title: "Dependent Work Rights & Travel Advice",
    description:
      "We explain the work rights available to dependents and offer travel planning assistance, including advice on school admissions, healthcare, and lifestyle overseas.",
    image: "/services/spouse-child/4.png",
  },
];
    ...
    <div className="font-sans">
      ...
      <section className="min-h-screen bg-gradient-to-r from-[#3c3c3c] to-[#445366] text-white flex flex-col lg:flex-row items-center px-6 lg:px-20 py-20 gap-10">
        ...
        <div className="lg:w-2/3">
          <Image
            src="/services/services-hero/3.png"
            alt="Admission"
            width={500}
            height={600}
