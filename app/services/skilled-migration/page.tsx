...
const steps = [
  {
    title: "Points-Based PR Eligibility Check",
    description:
      "We evaluate your profile against immigration point systems (like Canada, Australia) to determine your eligibility for permanent residency.",
    image: "/services/skilled-migration/1.png",
  },
  {
    title: "Express Entry (Canada), Skilled Migration (Australia/NZ), etc.",
    description:
      "We guide you through the most suitable PR pathways—whether it’s Canada’s Express Entry or Australia/New Zealand’s General Skilled Migration program.",
    image: "/services/skilled-migration/2.png",
  },
  {
    title: "Resume & Experience Verification",
    description:
      "We help tailor your resume to meet international immigration standards and verify your work experience to meet skill assessment requirements.",
    image: "/services/skilled-migration/3.png",
  },
  {
    title: "EOI (Expression of Interest) Submission",
    description:
      "We assist in drafting and submitting your Expression of Interest accurately, boosting your chances of receiving an Invitation to Apply (ITA).",
    image: "/services/skilled-migration/4.png",
  },
  {
    title: "End-to-end PR Application Management",
    description:
      "From start to finish, we manage your PR application process, ensuring documentation, timelines, and communication with immigration departments are handled professionally.",
    image: "/services/skilled-migration/5.png",
  },
];
      ...
      <section className="min-h-screen bg-gradient-to-r from-[#3c3c3c] to-[#445366] text-white flex flex-col lg:flex-row items-center px-6 lg:px-20 py-20 gap-10">
        <div className="lg:w-1/3 space-y-6">
          ...
          <button
            ...
            className="mt-6 bg-primary text-white px-8 py-4 rounded-lg"
          >
            Contact Us
          </button>
        </div>
        ...
        <div className="lg:w-2/3">
          <Image
            src="/services/services-hero/4.png"
            alt="Admission"
            width={500}
            height={600}
