...
const steps = [
  {
    title: "Eligibility & Document Assessment",
    description:
      "We assess your academic qualifications, visa category, and documentation to ensure your profile meets the visa requirements of your target country.",
    image: "/services/student-visa/1.png",
  },
  {
    title: "Financial Guidance (Funds, Loans, etc.)",
    description:
      "Our team helps you understand the financial documents required for visa processing. We also guide you in arranging proof of funds or accessing education loans, if needed.",
    image: "/services/student-visa/2.png",
  },
  {
    title: "Visa Application Submission",
    description:
      "We help you complete and submit your student visa application accurately and on time, minimizing the risk of delays or rejection.",
    image: "/services/student-visa/3.png",
  },
  {
    title: "Mock Interviews & Visa File Preparation",
    description:
      "Practice sessions prepare you for visa interviews with immigration officers, while we compile and review all necessary documents for a strong visa file.",
    image: "/services/student-visa/4.png",
  },
  {
    title: "Pre-departure Briefing",
    description:
      "Before you travel, we provide an essential orientation covering what to expect abroad, helping you start your journey with clarity and confidence.",
    image: "/services/student-visa/5.png",
  },
];
      ...
      <section className="bg-primary text-white flex flex-col lg:flex-row items-center px-6 lg:px-20 py-8 gap-10">
        <div className="lg:w-1/3 space-y-6">
         ...
         <div className="lg:w-2/3">
                  <Image
                    src="/services/services-hero/2.png"
                    alt="Admission"
                    width={500}
                    height={600}
