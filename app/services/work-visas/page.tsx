...
const steps = [
  {
    ...
    description:
      "We assist in securing job offers and guiding you through employer-sponsored visa processes, ensuring that both you and your employer meet the criteria.",
    image: "/services/work-visa/1.png",
  },
  {
    title: "Temporary Work Permits",
    description:
      "For those planning short-term stays abroad, we help you apply for temporary work permits based on your skillset and job role.",
    image: "/services/work-visa/2.png",
  },
  {
    title: "Intra-Company Transfers",
    description:
      "If your current company offers global mobility, we support your transfer under programs like L1 (USA) or ICT (Canada), ensuring compliance with rules.",
    image: "/services/work-visa/3.png",
  },
  {
    title: "Documentation & LMIA (Canada) / Job Checks (NZ)",
    description:
      "We assist with country-specific procedures such as Labour Market Impact Assessments (LMIA) in Canada or job check processes in New Zealand to validate employment eligibility.",
    image: "/services/work-visa/4.png",
  },
];
...
export default function AdmissionPage() {
  ...
  return (
    <div className="font-sans">
      {/* Hero */}
      <section className="bg-primary text-white flex flex-col lg:flex-row items-center px-6 lg:px-20 py-20 gap-10">
        ...
        <div className="lg:w-2/3">
          <Image
            src="/services/services-hero/5.png"
            alt="Admission"
            width={500}
            height={600}
